...
*   `typ_dokumentu`: Klasifikácia dokumentu (napr. "Oznámenie o začatí konania", "Rozhodnutie zo zisťovacieho konania", "Kolaudačné rozhodnutie", "Stavebné povolenie", "Oznámenie o výrube", "Informácia pre verejnosť", "Žiadosť", "Strategický dokument", "Verejná vyhláška", "Upovedomenie o predĺžení lehoty", "Výzva", "Žiadosť o povolenie výnimky", "Žiadosť o udelenie súhlasu"). Ak ide o akýkoľvek typ rozhodnutia, hodnota MUSÍ obsahovať slovo "rozhodnutie" (napr. "Rozhodnutie", "Kolaudačné rozhodnutie", "Rozhodnutie o zastavení konania"). Identifikuj hlavný účel dokumentu.
...
*   `typ_uzemia`: Zoznam explicitne spomenutých typov alebo názvov chránených území (napr. "Národný park", "CHKO", "Prírodná rezervácia", "Chránený areál", "Územie európskeho významu", "NATURA 2000", "SKUEV", "SKCHVU", "CHVO", "ochranné pásmo vodárenského zdroja", "ochranné pásmo VN vedenia", "ochranné pásmo plynovodu"). Ak je v dokumente číslo stupňa ochrany (napr. "4. stupeň", "5. stupeň"), pridaj to tiež do "typ_uzemia". Ak je v dokumente napísané, že sa netýka chráneného územia, daj tam "nechránené". Ak sa v dokumente nespomína, či ide o chránené územie, daj tam "neviem". Ak sa netýka žiadneho územia, ponechaj prázdny zoznam `[]`.
